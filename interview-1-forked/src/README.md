...
Örnek çıktıyı ve bu bileşeni nasıl oluşturmanız gerektiğine dair bilgileri `interview1.png` adlı resimde bulabilirsiniz.

**BAŞLANGIÇ KODU**

En rahat ettiğiniz ortamı kullanabilirsiniz. Başlamak için gereken bazı kod parçacıklarını `App.js` dosyasında bulabilirsiniz. -->
